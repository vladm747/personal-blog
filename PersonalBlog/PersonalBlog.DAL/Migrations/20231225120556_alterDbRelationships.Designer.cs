...
namespace PersonalBlog.DAL.Migrations
{
    ...
    [Migration("20231225120556_alterDbRelationships")]
    partial class alterDbRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4f7c4ace-7e1b-4370-a0ec-671061377756",
                            Name = "author",
                            NormalizedName = "AUTHOR"
                        },
                        new
                        {
                            Id = "7743c921-aca4-4111-a929-0df16d966fd5",
                            Name = "user",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("PersonalBlog.DAL.Entities.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PersonalBlog.DAL.Entities.Auth.User", null)
                        .WithMany()
